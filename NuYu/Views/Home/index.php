<!--JUMBOTRON-->
     <div class="jumbotron">
        ...
        <p class="lead">NuYu is a fitness tracker app that takes your needs into account. NuYu can help you obtain a goal weight or keep you in shape. Some features include: an excercise tracker to ensure you are working to your potential , a food tracker to keep track of your caloric intake, and a progress report to keep you up to date on your weight loss. Sign up today and let NuYu create the 'New You.' </p>
	...
	<div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <p><a class="btn btn-default" href="/NuYu/Controllers/progress.php" role="button">View details &raquo;</a></p>
       </div>
        <div class="col-md-4">
          <h2>Contact</h2>
